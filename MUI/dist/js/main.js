...
module.exports = Home;
},{"./Navbar":203,"react":199}],201:[function(require,module,exports){
var React = require('react');
var Navbar = require('./Navbar');
...
},{"./Navbar":203,"react":199}],202:[function(require,module,exports){
var React = require('react');
var Navbar = require('./Navbar');
...
},{"./Navbar":203,"./SearchBox":204,"react":199}],203:[function(require,module,exports){
var React = require('react');
                ...
                React.createElement("div", {className: "container"}, 
                    ...
                    React.createElement("div", {className: "nav-collapse collapse navbar-responsive-collapse"}, 
                        React.createElement("ul", {className: "nav navbar-nav"}, 
                            ...
                            React.createElement("li", {className: ""}, React.createElement(Link, {to: "/MyApp"}, "Add Movies"))
    ...
    createAjax: function(e){
        ...
        .done(function(data) {
            ...
            actualData.forEach(function(movie) {
              ...
              myResults.push(React.createElement(SingleMovie, {title: movie.Title, poster: movie.Poster, year: movie.Year, imdbid: movie.imdbID}));
            });
            self.setState({
              data: myResults
            });
    ...
    render: function() {
        return (
          ...
          React.createElement("div", null, 
            React.createElement("div", {className: "well"}, 
            React.createElement("div", {className: "container"}, 
                React.createElement("input", {type: "text", ref: "query", className: "form-control"}), 
            React.createElement("div", {className: "form-group"}, 
            React.createElement("div", {className: "col-sm-offset-0 col-sm-10"}, 
                React.createElement("input", {type: "submit", onClick: this.createAjax, value: "Search", className: "btn btn-success"}), 
...
},{"./Navbar":203,"./SingleMovie":205,"react":199}],205:[function(require,module,exports){
var React = require('react');

var SingleMovie = React.createClass({displayName: "SingleMovie",
    render: function() {
      return (
        React.createElement("div", {className: "row", id: "features"}, 
          React.createElement("div", {className: "col-sm-4 feature"}, 
          React.createElement("img", {src: this.props.poster, height: "250", width: "300"}), React.createElement("hr", null)
          ), 
          React.createElement("div", {className: "col-sm-4 feature"}, 
              React.createElement("p", {id: "details"}, React.createElement("b", null, 
                "Title :", this.props.title, React.createElement("br", null), 
                "Year :", this.props.year, React.createElement("br", null), 
                "Movie Id :", this.props.imdbid, React.createElement("br", null)))
          ), 
          React.createElement("div", {className: "col-sm-4 feature"}, 

                  React.createElement("input", {type: "submit", className: "btn btn-info", value: "Edit", "data-target": "#myModal" +this.props.imdbid, "data-toggle": "modal"}), 

                  React.createElement("div", {className: "modal fade", id: "myModal"+this.props.imdbid, tabindex: "-1", role: "dialog", "aria-labelledby": "myModalLabel", "aria-hidden": "true"}, 
                  React.createElement("div", {className: "modal-dialog"}, 
                  React.createElement("div", {className: "modal-content"}, 

                  React.createElement("div", {className: "modal-header"}, 
                      React.createElement("button", {className: "close", "data-dismiss": "modal"}, "×"), 
                      React.createElement("h4", {className: "modal-title"}, "Edit / Update Movie Details")
                  ), 

                  React.createElement("div", {className: "modal-body"}, 
                  React.createElement("div", {className: "col-sm-4 feature"}, 
                    React.createElement("img", {src: this.props.poster, height: "150", width: "150"})
                    ), 
                    React.createElement("div", {className: "col-sm-4 feature"}, 
                    React.createElement("p", {id: "details"}, React.createElement("b", null, 
                      "Title :", this.props.title, React.createElement("br", null), 
                  ...
                  React.createElement("div", {className: "modal-footer"}, 
                              ...
                              React.createElement("button", {className: "btn btn-primary", type: "button"}, "Save Changes")
                  )
...
},{"./routes.js":209,"react":199,"react-dom":10,"react-router":35}],207:[function(require,module,exports){
var React = require('react');
...
},{"../../components/MainLayout":201,"../../components/MyApp":202,"../../components/SearchBox":204,"../../components/SingleMovie":205,"react":199}],208:[function(require,module,exports){
var React = require('react');
var Router = require('react-router');
...
},{"react":199,"react-router":35}],209:[function(require,module,exports){
var React = require('react');
var Router = require('react-router');
...
React.createElement(Route, null, 
        ...
        React.createElement(Route, {handler: MyApp, name: "movieapp", path: "/myapp"})

)
);
},{"./components/Home":200,"./components/MyApp":202,"./pages/Home/Home":207,"./pages/Master/Master":208,"react":199,"react-router":35}]},{},[206]);
